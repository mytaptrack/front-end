...
import {
    StudentBehavior, StudentClass, StudentResponse,
    Student, StudentBehaviorClass, StudentResponseClass, moment
} from '../..';
...
export class StudentTrackableCollection {
    ...
    async addResponse(data?: StudentResponse) {
        ...
        const retval = new StudentResponseClass(data, this.student, this.userId, this.api);
        return retval;
    }
